document.addEventListener('DOMContentLoaded',()=>{
    ...
    document.getElementById('bookingForm').addEventListener('submit',e=>{
        ...
        const all=JSON.parse(localStorage.getItem('etique_bookings')||'[]');all.push(d);localStorage.setItem('etique_bookings',JSON.stringify(all));
        e.target.reset();showToast('Thank you. Your request is under review.');
    });
});
function bookSvc(s){
